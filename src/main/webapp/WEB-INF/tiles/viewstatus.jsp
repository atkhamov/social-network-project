...
<%@ taglib tagdir="/WEB-INF/tags" prefix="akmal" %>
...
<div class="row">
    <div class="col-md-8 col-md-offset-2">
        ...
        <%--'page' in curly brackets is the object of 'org.springframework.data.domain.Page'--%>
        <akmal:pagination url="${url}" page="${page}" size="7"/>
